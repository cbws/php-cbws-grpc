 ...
 *
 * Generated from protobuf message <code>cbws.logging.v1alpha1.HttpRequest</code>
 */
class HttpRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string request_uri = 2;</code>
     */
     ...
     * True.
     *
     * Generated from protobuf field <code>bool cache_is_origin_server_validated = 10;</code>
     */
    protected $cache_is_origin_server_validated = false;
    /**
     ...
     *           Whether or not an entity was served from cache
     *           (with or without validation).
     *     @type bool $cache_is_origin_server_validated
     *           Whether or not the response was validated with the origin server before
     *           being served from cache. This field is only meaningful if `cache_hit` is
     *           True.
     ...
     * @return bool
     */
    public function getCacheIsOriginServerValidated()
    {
        return $this->cache_is_origin_server_validated;
    }
     ...
     * @return $this
     */
    public function setCacheIsOriginServerValidated($var)
    {
        GPBUtil::checkBool($var);
        $this->cache_is_origin_server_validated = $var;
