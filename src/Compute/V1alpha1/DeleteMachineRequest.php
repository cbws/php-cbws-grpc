...
/**
 * The machine delete request.
 *
 * Generated from protobuf message <code>cbws.compute.v1alpha1.DeleteMachineRequest</code>
 */
class DeleteMachineRequest extends \Google\Protobuf\Internal\Message
{
    /**
