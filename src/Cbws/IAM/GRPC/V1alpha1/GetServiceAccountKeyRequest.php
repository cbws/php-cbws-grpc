 ...
 *
 * Generated from protobuf message <code>cbws.iam.v1alpha1.GetServiceAccountKeyRequest</code>
 */
class GetServiceAccountKeyRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.cbws.iam.v1alpha1.ServiceAccountPublicKeyType public_key_type = 2;</code>
     */
    protected $public_key_type = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Cbws\IAM\GRPC\V1alpha1\ServiceAccountPublicKeyType::class);
